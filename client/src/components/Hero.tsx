...
import BookNowModal from "./BookNowModal"; // Import BookNowModal component
...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="pt-32 md:pt-40 pb-16 md:pb-24 px-4 sm:px-6 lg:px-8 bg-gray-50"
      >
          ...
          <div className="lg:flex items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-lg">
                Experience gentle, effective chiropractic care tailored to your
                needs. Whether you're dealing with back pain, neck tension, or
                recovering from injury — we're here to help.
              </p>
