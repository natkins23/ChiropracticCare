  ...
  const quizSteps = [
    {
      ...
      options: ['Neck', 'Lower Back', 'Mid Back', 'Shoulders', 'Hips/Legs', 'Headaches'],
      cols: 2
    },
    {
    ...
    },
    {
      ...
      options: ['Constantly', 'Several times daily', 'A few times a week', 'Occasionally'],
      cols: 2
    },
    {
      title: "What triggers or worsens your pain?",
      options: ['Sitting', 'Standing', 'Physical activity', 'Stress', 'Sleep position', 'Unknown'],
      cols: 2
    },
    {
      title: "When is your pain typically at its worst?",
      options: ['Morning', 'Afternoon', 'Evening', 'Night', 'After activity', 'No pattern'],
      cols: 2
    },
    {
      title: "How does this pain limit you?",
      options: ['Work performance', 'Sleep quality', 'Exercise/activities', 'Daily tasks', 'Mood/mental health', 'Not limiting'],
      cols: 2
    },
    {
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 relative">
            ...
            <div className="mb-8">
              <div className="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                <motion.div 
                  ...
                  initial={{ width: 0 }}
                  animate={{ width: `${(currentStep / quizSteps.length) * 100}%` }}
          ...
          <AnimatePresence custom={direction} mode="wait">
            {currentStep < 8 && (
              ...
              >
                <h3 className="text-xl font-semibold mb-6">{quizSteps[currentStep].title}</h3>
                <div className={`grid grid-cols-1 ${quizSteps[currentStep].cols === 2 ? 'md:grid-cols-2' : ''} gap-4`}>
                    ...
                    <div className="w-full max-w-md mx-auto">
                      <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                          ...
                          />
                          {errors.name && (
                            <p className="mt-1 text-red-500 text-sm text-left">{errors.name}</p>
                          )}
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          />
                          {errors.phone && (
                            <p className="mt-1 text-red-500 text-sm text-left">{errors.phone}</p>
                          )}
                        </div>
                        <div>
                          <label htmlFor="message" className="block text-sm font-medium text-gray-700 text-left">Additional Comments (Optional)</label>
                          <textarea
                            id="message"
                        ...
                        <input type="hidden" name="pain-intensity" value={answers.painIntensity} />
                        <input type="hidden" name="pain-frequency" value={answers.painFrequency} />
                        <input type="hidden" name="pain-triggers" value={answers.painTriggers} />
